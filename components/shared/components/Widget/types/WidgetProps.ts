...
export type WidgetPane1Props = {
  ...
  preset_donation_amount_1_recurring: number;
  preset_donation_amount_2_recurring: number;
  preset_donation_amount_3_recurring: number;
  preset_donation_amount_1_single: number;
  preset_donation_amount_2_single: number;
  preset_donation_amount_3_single: number;
