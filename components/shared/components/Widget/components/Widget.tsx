        ...
        <Carousel minHeight={scaledHeight - 116}>
          <DonationPane
            text={{
              ...
              preset_donation_amount_1_recurring: text.preset_donation_amount_1_recurring,
              preset_donation_amount_2_recurring: text.preset_donation_amount_2_recurring,
              preset_donation_amount_3_recurring: text.preset_donation_amount_3_recurring,
              preset_donation_amount_1_single: text.preset_donation_amount_1_single,
              preset_donation_amount_2_single: text.preset_donation_amount_2_single,
              preset_donation_amount_3_single: text.preset_donation_amount_3_single,
